    ...
    <section class="form-fields container">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input
                    ...
                    type="email"
                    value="{$rdv.email}"
                    placeholder="{l s='your@email.com' mod='hsrdv'}"
                >
            </div>
        </div>
        ...
        <div id="appareils-container">
            <ul id="tabs">
                ...
                {/foreach}
                <span class="plus"><button class="add-appareil">+</button></span>
            </ul>
            ...
            <div id="addSubFormButton" class="add-appareil">
            ...
            <div>
                <div class="">
                    {*<label for="demande_newsletter">*}
                    <input id="demande_newsletter"
                            class="newsletter"
                            name="newsletter"
                            type="checkbox"
                            {if $rdv.newsletter}checked{/if}
                    >
                    <label>{l s='Je souhaite recevoir la newsletter' d='Modules.Hsrdv.Shop'}</label>
                    </input>
                </div>
            </div>
            <div>
                <span id="rappelVerificationMail" class="hsrdv-note">{l s='Verifiez votre email avant d\'envoyer' d='Modules.Hsrdv.Shop'}</span>
            </div>
        </div>
    </section>
